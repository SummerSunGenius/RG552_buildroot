...
ifeq ($(BR2_PACKAGE_ANBERNIC_TARGET_MIQI),y)
...
define MALI_T760_INSTALL_STAGING_CMDS
	...
	cp $(BR2_EXTERNAL_ANBERNIC_PATH)/package/anbernic/gpu/mali-T760/gbm.pc $(MALI_T760_STAGING_DIR)/usr/lib/pkgconfig/gbm.pc
	cp $(BR2_EXTERNAL_ANBERNIC_PATH)/package/anbernic/gpu/mali-T760/egl.pc $(MALI_T760_STAGING_DIR)/usr/lib/pkgconfig/egl.pc
	cp $(BR2_EXTERNAL_ANBERNIC_PATH)/package/anbernic/gpu/mali-T760/glesv2.pc $(MALI_T760_STAGING_DIR)/usr/lib/pkgconfig/glesv2.pc
    cp $(BR2_EXTERNAL_ANBERNIC_PATH)/package/anbernic/gpu/mali-T760/mali.pc $(MALI_T760_STAGING_DIR)/usr/lib/pkgconfig/mali.pc
endef
