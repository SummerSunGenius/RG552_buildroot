...
define MALI_RK450_INSTALL_STAGING_CMDS
	...
	cp $(BR2_EXTERNAL_ANBERNIC_PATH)/package/anbernic/gpu/mali-rk450/gbm.pc $(MALI_RK450_STAGING_DIR)/usr/lib/pkgconfig/gbm.pc
	cp $(BR2_EXTERNAL_ANBERNIC_PATH)/package/anbernic/gpu/mali-rk450/egl.pc $(MALI_RK450_STAGING_DIR)/usr/lib/pkgconfig/egl.pc
	cp $(BR2_EXTERNAL_ANBERNIC_PATH)/package/anbernic/gpu/mali-rk450/glesv2.pc $(MALI_RK450_STAGING_DIR)/usr/lib/pkgconfig/glesv2.pc
endef
