...
ifeq ($(BR2_PACKAGE_ANBERNIC_TARGET_S912)$(BR2_PACKAGE_ANBERNIC_TARGET_VIM2),y)
UBOOT_AMLOGIC_FIPDIR="$(@D)/khadas-vim2"
UBOOT_AMLOGIC_ENCRYPT_BIN="aml_encrypt_gxl"
endif
ifeq ($(BR2_PACKAGE_ANBERNIC_TARGET_VIM3),y)
...
ifeq ($(BR2_PACKAGE_ANBERNIC_TARGET_VIM3)$(BR2_PACKAGE_ANBERNIC_TARGET_ODROIDN2)$(BR2_PACKAGE_ANBERNIC_TARGET_ODROIDC4),y)
