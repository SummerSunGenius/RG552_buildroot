...
class EsSystemConf:
    ...
    def createEsFeatures(featuresYaml, systems, esFeaturesFile, arch):
        ...
        for emulator in features:
            emulator_featuresTxt = "videomode" # on anbernic, the videomode is supported for any board allowing to change resolution via configgen. It is not related to the emulator
