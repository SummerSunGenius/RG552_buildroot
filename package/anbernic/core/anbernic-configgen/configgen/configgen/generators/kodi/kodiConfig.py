...
def writeKodiConfigs(currentControllers):
    ...
    for controller in currentControllers:
        ...
        kodiJoy = open(anbernicFiles.kodiJoystick.format(cur.guid), "w")
        # TODO: python 3 - workawround to encode files in utf-8
        kodiJoy = codecs.open(anbernicFiles.kodiJoystick.format(cur.guid), "w", "utf-8")
...
def writeKodiConfig(controllersFromES):
    ...
    if len(controllersFromES) == 0:
        return
    directory = os.path.dirname(anbernicFiles.kodiJoystick)
