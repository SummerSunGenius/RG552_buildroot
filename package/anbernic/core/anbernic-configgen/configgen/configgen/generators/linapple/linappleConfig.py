...
def generateLinappleConfig(rom, playersControllers, gameResolution):
    # conf file
    try:
        linappleConfig = UnixSettings(anbernicFiles.linappleConfigFile, separator=' ')
    except UnicodeError:
        # remove it and try again
        os.remove(anbernicFiles.linappleConfigFile)
        linappleConfig = UnixSettings(anbernicFiles.linappleConfigFile, separator=' ')
    ...
    linappleConfig.save('Save State Directory', anbernicFiles.linapplaSaves)
