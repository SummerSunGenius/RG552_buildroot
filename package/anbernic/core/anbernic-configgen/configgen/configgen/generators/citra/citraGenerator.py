...
class CitraGenerator(Generator):
    ...
    def generate(self, system, rom, playersControllers, gameResolution):
        CitraGenerator.writeCITRAConfig(anbernicFiles.citraConfig, system, playersControllers)

        commandArray = [anbernicFiles.anbernicBins[system.config['emulator']], rom]
        return Command.Command(array=commandArray, env={"XDG_CONFIG_HOME":anbernicFiles.CONF, "XDG_DATA_HOME":anbernicFiles.citraSaves, "XDG_CACHE_HOME":anbernicFiles.CACHE, "QT_QPA_PLATFORM":"xcb"})
