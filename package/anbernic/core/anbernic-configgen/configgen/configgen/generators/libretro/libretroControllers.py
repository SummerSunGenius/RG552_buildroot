...
def writeControllersConfig(retroconfig, system, controllers):
    ...
    retroarchspecials = {'pageup': 'load_state', \
                         'start': 'exit_emulator', 'up': 'volume_up', \
                         'down': 'volume_down', 'left': 'state_slot_decrease', 'right': 'state_slot_increase', \
                         'l2': 'toggle_fast_forward', 'r2': 'fps_toggle', 'a': 'menu_toggle', 'pagedown': 'save_state'}
