...
def setMupenConfig(iniConfig, system, controllers, gameResolution):
	...
	iniConfig.set("Core", "ScreenshotPath", anbernicFiles.SCREENSHOTS)
	iniConfig.set("Core", "SaveStatePath",  anbernicFiles.mupenSaves)
	iniConfig.set("Core", "SaveSRAMPath",   anbernicFiles.mupenSaves)
	iniConfig.set("Core", "SharedDataPath", anbernicFiles.mupenConf)
	...
	if hdmi_check_file.readline()=="connected\n":
		iniConfig.set("Video-General", "ScreenWidth",  1280)
		iniConfig.set("Video-General", "ScreenHeight", 720)
	else:
		iniConfig.set("Video-General", "ScreenWidth",  1920)
		iniConfig.set("Video-General", "ScreenHeight", 1152)
