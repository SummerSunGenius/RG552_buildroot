...
class FsuaeGenerator(Generator):
    ...
    def generate(self, system, rom, playersControllers, gameResolution):
        ...
        commandArray = [anbernicFiles.anbernicBins[system.config['emulator']], "--fullscreen",
                                                                               "--amiga-model="     + system.config['core'],
                                                                               "--base_dir="        + anbernicFiles.fsuaeConfig,
                                                                               "--kickstarts_dir="  + anbernicFiles.fsuaeBios,
                                                                               "--save_states_dir=" + anbernicFiles.fsuaeSaves + "/" + system.config['core'] + "/" + self.filePrefix(rom),
                                                                               "--zoom=auto"
                       ]
