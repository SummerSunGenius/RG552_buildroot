#!/usr/bin/env python
HOME_INIT = '/usr/share/anbernic/datainit/system/'
...
mupenMappingSystem  = '/usr/share/anbernic/datainit/system/configs/mupen64/input.xml'

kodiJoystick = HOME + '/.kodi/userdata/addon_data/peripheral.joystick/resources/buttonmaps/xml/linux/anbernic_{}.xml'
...
overlaySystem = "/usr/share/anbernic/datainit/decorations"
