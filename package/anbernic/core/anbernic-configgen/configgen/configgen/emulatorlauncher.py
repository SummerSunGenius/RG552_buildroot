...
def main(args, maxnbplayers):
    ...
    try:
        ...
        dirname = os.path.join(anbernicFiles.savesDir, system.name)
        ...
        callExternalScripts("/usr/share/anbernic/configgen/scripts", "gameStart", [systemName, system.config['emulator'], effectiveCore, effectiveRom])
        ...
        callExternalScripts("/usr/share/anbernic/configgen/scripts", "gameStop", [systemName, system.config['emulator'], effectiveCore, effectiveRom])
