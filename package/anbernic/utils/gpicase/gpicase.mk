...
define GPICASE_INSTALL_TARGET_CMDS
	...
	cp $(BR2_EXTERNAL_ANBERNIC_PATH)/package/anbernic/utils/gpicase/99-gpicase.rules                  $(TARGET_DIR)/etc/udev/rules.d
	cp $(BR2_EXTERNAL_ANBERNIC_PATH)/package/anbernic/utils/gpicase/anbernic-gpicase-install          $(TARGET_DIR)/usr/bin/anbernic-gpicase-install
endef
