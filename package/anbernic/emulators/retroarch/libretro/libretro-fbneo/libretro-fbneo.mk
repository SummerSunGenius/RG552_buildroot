...
ifeq ($(BR2_PACKAGE_ANBERNIC_TARGET_X86) $(BR2_PACKAGE_ANBERNIC_TARGET_X86_64),y)
...
define LIBRETRO_FBNEO_INSTALL_TARGET_CMDS
	...
	# Bios
	mkdir -p $(TARGET_DIR)/usr/share/anbernic/datainit/bios/fbneo/samples
	$(INSTALL) -D $(@D)/metadata/* \
		$(TARGET_DIR)/usr/share/anbernic/datainit/bios/fbneo
