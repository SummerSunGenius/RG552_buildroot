...
ifeq ($(BR2_PACKAGE_ANBERNIC_TARGET_X86_ANY),y)
  LIBRETRO_PICODRIVE_PLATFORM = x86
endif

ifeq ($(BR2_PACKAGE_ANBERNIC_TARGET_RPI3)$(BR2_PACKAGE_ANBERNIC_TARGET_RPI4)$(BR2_PACKAGE_ANBERNIC_TARGET_ODROIDGOA),y)
