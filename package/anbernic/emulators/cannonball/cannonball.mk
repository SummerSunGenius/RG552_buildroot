...
define CANNONBALL_INSTALL_TARGET_CMDS
	...
	mkdir -p $(TARGET_DIR)/usr/share/anbernic/datainit/system/configs/cannonball/res/
	$(INSTALL) -D $(@D)/buildroot-build/res/tilemap.bin $(TARGET_DIR)/usr/share/anbernic/datainit/system/configs/cannonball/
	$(INSTALL) -D $(@D)/buildroot-build/res/tilepatch.bin $(TARGET_DIR)/usr/share/anbernic/datainit/system/configs/cannonball/
	$(INSTALL) -D $(@D)/buildroot-build/config.xml $(TARGET_DIR)/usr/share/anbernic/datainit/system/configs/cannonball/config_help.txt
endef
