...
define CEMU_INSTALL_TARGET_CMDS
	...
	# keys.txt
	mkdir -p $(TARGET_DIR)/usr/share/anbernic/datainit/bios/cemu
	touch $(TARGET_DIR)/usr/share/anbernic/datainit/bios/cemu/keys.txt
	...
	cp -prn $(BR2_EXTERNAL_ANBERNIC_PATH)/package/anbernic/emulators/cemu/cemu/wiiu.keys $(TARGET_DIR)/usr/share/evmapy
