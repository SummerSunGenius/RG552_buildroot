...
ifeq ($(BR2_PACKAGE_ANBERNIC_TARGET_X86),y)
	MUPEN64PLUS_HOST_CPU = i586
endif

ifeq ($(BR2_PACKAGE_ANBERNIC_TARGET_X86_64),y)
...
define MUPEN64PLUS_CORE_INSTALL_TARGET_CMDS
	...
	# input.xml
	mkdir -p $(TARGET_DIR)/usr/share/anbernic/datainit/system/configs/mupen64
	cp $(BR2_EXTERNAL_ANBERNIC_PATH)/package/anbernic/emulators/mupen64plus/mupen64plus-core/controllers/input.xml \
		$(TARGET_DIR)/usr/share/anbernic/datainit/system/configs/mupen64
endef
