...
define XARCADE2JSTICK_INSTALL_TARGET_CMDS
    ...
    # config
	mkdir -p $(TARGET_DIR)/usr/share/anbernic/datainit/system/configs/xarcade2jstick
	cp $(BR2_EXTERNAL_ANBERNIC_PATH)/package/anbernic/controllers/xarcade2jstick/config/* \
		$(TARGET_DIR)/usr/share/anbernic/datainit/system/configs/xarcade2jstick
endef
