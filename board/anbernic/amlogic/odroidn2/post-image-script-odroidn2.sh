...
(cd "${BINARIES_DIR}/boot" && tar -I "xz -T0" -cf "${ANBERNIC_BINARIES_DIR}/boot.tar.xz" extlinux tools boot anbernic-boot.conf boot-logo.bmp.gz boot.ini config.ini) || exit 1
