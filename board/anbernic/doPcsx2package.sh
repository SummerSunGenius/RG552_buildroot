...
# run manually:  board/anbernic/doPcsx2package.sh "output/target" "output/pcsx2" "output/images/anbernic"
...
XTARGET_VERSION=$(cat "${G_TARGETDIR}/usr/share/anbernic/anbernic.version" | sed -e s+" .*$"++)
XTARGET_ARCH=$(cat "${G_TARGETDIR}/usr/share/anbernic/anbernic.arch")
