...
TARGET_IMAGE="${BINARIES_DIR}/anbernic"
...
XTARGET_VERSION=$(grep -E "^ANBERNIC_SYSTEM_VERSION[ ]*=" "${BR2_EXTERNAL_ANBERNIC_PATH}/package/anbernic/core/anbernic-system/anbernic-system.mk" | sed -e s+"^ANBERNIC_SYSTEM_VERSION[ ]*=[ ]*\(.*\)[ ]*$"+'\1'+)
XTARGET_ARCH="x86"
